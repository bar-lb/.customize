...
rfsbuild_kernelight(){ # build relevant rootfses for running kernelight tests
    rfsbuild product_base$testOS
}


rfsbuild_system(){ # build relevant rootfses for running system tests
    rfsbuild product$testOS
    rfsbuild host_basic
}
